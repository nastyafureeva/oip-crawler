...
После построения индекса и расчёта TF-IDF можно запустить
WEB-интерфейс поисковой системы.
...
Через web-страницу можно:
ввести текстовый запрос
выполнить векторный поиск
получить top-10 результатов
увидеть ранжирование документов по релевантности
